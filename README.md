...
| Project | Description | Tech |
| :--- | :--- | :--- |
| [exampulse-ai](https://github.com/SnakeEye-sudo/exampulse-ai) | AI-powered current affairs intelligence and revision platform for Indian government-exam aspirants. Zero-maintenance: GitHub Actions ingests, scores and enriches news daily; the repo is the database. | `TypeScript` |
